...
\definecolor{monokaiback}{HTML}{F7F7F7}  % Lighter background color
\definecolor{monokaicomment}{HTML}{75715E}
\definecolor{monokaikeyword}{HTML}{F92672}
\definecolor{monokaistring}{HTML}{E6DB74}
\definecolor{monokainumber}{HTML}{AE81FF}
\definecolor{monokaioperator}{HTML}{F92672}
\definecolor{monokaiidentifier}{HTML}{A6E22E}

\lstdefinestyle{codestyle}{
    backgroundcolor=\color{monokaiback},
    commentstyle=\color{monokaicomment},
    keywordstyle=\color{monokaikeyword},
    numberstyle=\tiny\color{monokainumber},
    stringstyle=\color{monokaistring},
    operatorstyle=\color{monokaioperator},
    identifierstyle=\color{monokaiidentifier},
    basicstyle=\ttfamily\footnotesize\color{black},  % Black text for better readability
    ...
    showtabs=false,
    tabsize=4,
    frame=lines,  % adds lines at the top and bottom of the code block
    framesep=3pt,  % frame padding
    rulecolor=\color{monokaiback},  % frame color
}
